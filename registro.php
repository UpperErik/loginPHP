      ...
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
          ...
          <div class="card-body p-4 p-sm-5">
            <h5 class="card-title text-center mb-5 fw-light fs-2 fw-bolder"">Registrarse</h5>
            <form action="servidor/registro/registrar.php" method="post">
              ...
              <a class="d-block text-center mt-2 small" href="index.php">Si tienes una cuenta, ingresa</a>
